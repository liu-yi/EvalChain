...
console.log(web3Utils.soliditySha3(new BN('8')))
console.log(web3Utils.keccak256('0x' + new BN('8').toString(16, 64)))
main()
...
function main() {
  ...
  console.log(verifyRingSignature(MDigest, newY, sign[0], sign[1], sign[2]))
...
*/
function ringSign(signingKey, M, _y) {
  var y = shuffle(_y)
